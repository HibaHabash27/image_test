...
class Services {
  ...
  static const ROOT ="http://127.0.0.1/glam/image_action.php";

  static var url = Uri.parse(ROOT);
  ...
  //Method to add Image
  static Future<String> addImage(String imageString , int prd_id) async {
    try {
      var map = <String, dynamic>{};
      map['action'] = _ADD_IMAGE_ACTION;
      map['image_code'] = imageString;
      map['prd_id'] = prd_id.toString();
      final response = await http.post(url, body: map);
